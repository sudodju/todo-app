...
Небольшое веб-приложение, которое реализует функциональность планировщика задач — TODO-лист написанный на Go с хранением данных в SQLite. Проект предоставляет веб‑интерфейс и REST API для управлением списком задач.
